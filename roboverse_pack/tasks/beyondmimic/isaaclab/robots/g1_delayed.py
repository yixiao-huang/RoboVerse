...
from roboverse_pack.tasks.beyondmimic.isaaclab.robots.actuator import DelayedImplicitActuatorCfg
...
G1_DELAYED_CYLINDER_CFG = ArticulationCfg(
...
G1_ACTION_SCALE = {}
for a in G1_DELAYED_CYLINDER_CFG.actuators.values():
