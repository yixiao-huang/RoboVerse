...
class TrackingRLEnv(TrackingBaseEnv, gym.Env):
    ...
    def load_managers(self):
        ...
        log.info("[INFO] Termination Manager: ", self.termination_manager)
        # -- reward manager
        self.reward_manager = RewardManager(self.cfg.rewards, self)
        log.info("[INFO] Reward Manager: ", self.reward_manager)
        # -- curriculum manager
        self.curriculum_manager = CurriculumManager(self.cfg.curriculum, self)
        log.info("[INFO] Curriculum Manager: ", self.curriculum_manager)
    ...
    def step(self, action: torch.Tensor) -> VecEnvStepReturn:
        ...
        for _ in range(self.cfg.decimation):
            ...
            self.action_manager.apply_action()  # NOTE sets `_data.joint_pos_target`
