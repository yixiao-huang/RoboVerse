...
class MaterialRandomizer(BaseQueryType):
    """Randomize the material properties of the bodies."""
    ...
    def _randomize_isaacsim(self, env_ids: torch.Tensor):
        ...
        materials = (
            obj_inst.root_physx_view.get_material_properties()
        )  # (n_envs, n_shapes, 3) where 3 corresponds to static friction, dynamic friction, and restitution
...
class MassRandomizer(BaseQueryType):
    """Randomize the mass of the bodies."""
