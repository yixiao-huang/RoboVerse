...
#   --config_path roboverse_learn/il/multi-task/configs/task_configs.json \
...
# python roboverse_learn/il/data2zarr_dp_multitask_gpt.py \
  --task_config roboverse_learn/il/multi-task/configs/task_configs.json \
  --output_name multitask_franka_gpt \
